...
page_require_level(2);
$results = find_sale_by_Reparacion();
?>
 <?php
include "Paginacion/connect.php";
include "Paginacion/paginadorEstadoReparacion.php";
?>
 <!doctype html>
<html lang="en-US">
 <head>
   <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
   <title>Estados de Reparación</title>
...
<nav aira-label="Page navigation" class="text-center">
  <ul class="pagination" >
    ...
    <?php else: ?>
      <li >
      <a href="EstadoDañado.php?pagina=<?php echo $pagina - 1; ?>" aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
      </a>
    </li>
  <?php endif;
for ($i = 1; $i <= $numeropaginas; $i++) {
    if ($pagina == $i) {
        ...
        echo '<li><a href="EstadoDañado.php?pagina=' . $i . '">' . $i . '</a></li>';
    }
}
...
?>
    ...
    <?php else: ?>
      <li>
      <a href="EstadoDañado.php?pagina=<?php echo $pagina + 1; ?>" aria-label="Next">
        <span aria-hidden="true">&raquo;</span>
      </a>
    </li>
    <?php endif;?>
