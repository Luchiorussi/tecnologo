...
page_require_level(2);
$results = find_sale_by_Dañado();
?>
 <?php
include "Paginacion/connect.php";
include "Paginacion/paginadorEstadoDañado.php";
?>
...
for ($i = 1; $i <= $numeropaginas; $i++) {
    if ($pagina == $i) {
        echo '<li class="active"><a href="EstadoDañado.php?pagina=' . $i . '">' . $i . '</a></li>';
    } else {
