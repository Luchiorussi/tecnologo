...
page_require_level(2);
$results = find_sale_by_Malo();
?>
 <?php
include "Paginacion/connect.php";
include "Paginacion/paginadorEstadoMalo.php";
?>
...
<nav aira-label="Page navigation" class="text-center">
  <ul class="pagination" >
    ...
    <?php else: ?>
      <li >
      <a href="EstadoMalo.php?pagina=<?php echo $pagina - 1; ?>" aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
      </a>
    </li>
  <?php endif;
for ($i = 1; $i <= $numeropaginas; $i++) {
    if ($pagina == $i) {
        echo '<li class="active"><a href="EstadoMalo.php?pagina=' . $i . '">' . $i . '</a></li>';
    } else {
        echo '<li><a href="EstadoMalo.php?pagina=' . $i . '">' . $i . '</a></li>';
    }
}
...
?>
    ...
    <?php else: ?>
      <li>
      <a href="EstadoMalo.php?pagina=<?php echo $pagina + 1; ?>" aria-label="Next">
        <span aria-hidden="true">&raquo;</span>
      </a>
    </li>
    <?php endif;?>
