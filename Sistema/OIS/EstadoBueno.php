...
include "Paginacion/paginadorEstadoBueno.php";
?>
<?php
// Registrar qué nivel de usuario tiene permiso para ver esta página
page_require_level(2);
$results = find_sale_by_Bueno();
?>
  ...
  <div class="page-break">
       <div class="sale-head pull-right">
           ...
           <center>
                    ...
                    <button  class="btn btn-info" style="background:red;"><a href="PDFBueno.php" style="color: #FFF;">PDF</a></button>
                    </center>
                    <br>
             </div>
...
<nav aira-label="Page navigation" class="text-center">
  <ul class="pagination" >
    ...
    <?php else: ?>
      <li >
      <a href="EstadoBueno.php?pagina=<?php echo $pagina - 1; ?>" aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
      </a>
    </li>
  <?php endif;
for ($i = 1; $i <= $numeropaginas; $i++) {
    if ($pagina == $i) {
        echo '<li class="active"><a href="EstadoBueno.php?pagina=' . $i . '">' . $i . '</a></li>';
    } else {
        echo '<li><a href="EstadoBueno.php?pagina=' . $i . '">' . $i . '</a></li>';
    }
}
...
?>
    ...
    <?php else: ?>
      <li>
      <a href="EstadoBueno.php?pagina=<?php echo $pagina + 1; ?>" aria-label="Next">
        <span aria-hidden="true">&raquo;</span>
      </a>
    </li>
    <?php endif;?>
