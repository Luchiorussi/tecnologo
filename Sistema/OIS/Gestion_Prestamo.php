...
$FechaMaxima = date ( 'Y-m-d' , $nuevafechaYear );
	...
	$query= "SELECT NoDocumento FROM usuario WHERE NoDocumento = '$id' ";
	...
	<div id="ContPrestamo">
		<div id="ContDatos">
			...
			<form id="FormPrestamo">
				...
				<div>
					<label for="txtCarnetBi">Nombres Administrador:</label>
				...
				<div>
					<label for="dtpFecha">Fecha Inicio del Prestamo</label>
