...
include "Paginacion/paginadorEstadoRobado.php";
?>
<?php
// Registrar qué nivel de usuario tiene permiso para ver esta página
page_require_level(2);
$results = find_sale_by_Robado();
?>
...
<nav aira-label="Page navigation" class="text-center">
  <ul class="pagination" >
    ...
    <?php else: ?>
      <li >
      <a href="EstadoRobado.php?pagina=<?php echo $pagina - 1; ?>" aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
      </a>
    </li>
  <?php endif;
for ($i = 1; $i <= $numeropaginas; $i++) {
    if ($pagina == $i) {
        ...
        echo '<li><a href="EstadoRobado.php?pagina=' . $i . '">' . $i . '</a></li>';
    }
}
...
?>
    ...
    <?php else: ?>
      <li>
      <a href="EstadoRobado.php?pagina=<?php echo $pagina + 1; ?>" aria-label="Next">
        <span aria-hidden="true">&raquo;</span>
      </a>
    </li>
    <?php endif;?>
