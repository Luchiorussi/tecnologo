        ...
        <div class="panel panel-default">
          <div class="panel-heading clearfix">
            ...
            <div class="pull-right">
              <form class="form-inline" action="Imagenes.php" method="POST" enctype="multipart/form-data">
                ...
                <tr class="list-inline">
                 <td class="text-center"><?php echo count_id();?></td>
                  <td class="text-center">
                  	<img src="Cargas/Mobiliario<?php echo $media_file['NombreMedia'];?>" class="img-thumbnail" />
                  	</td>
                <td class="text-center">
                  <?php echo $media_file['NombreMedia'];?>
                  </td>
                <td class="text-center">
                  <?php echo $media_file['TipoMedia'];?>
                </td>

                <td class="text-center">
                  <a href="Eliminar_Imagen.php?id=<?php echo (int) $media_file['id'];?>" class="btn btn-danger btn-xs"  title="Eliminar">
