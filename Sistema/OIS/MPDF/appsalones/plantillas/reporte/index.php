  ...
  $plantilla= '<body>
    ...
    <main>
      <div id="details" class="clearfix">
        ...
        <div id="invoice">
          <br>
          <h1 align="center"> AULAS ACTIVAS E INACTIVAS </h1>
        </div>
      </div>
      <table border="0" cellspacing="0" cellpadding="0">
        <thead>
          <tr>
            <th class="no"><h3>Nombre del aula</h3></th>
            <th class="desc" ><h3>Numero de Salones</h3></th>
      ...
      foreach($conexion as $usuario){
        ...
        $plantilla .='<tr>
        <td class="total" align="left"><h3>'.$usuario["NombreAula"].'</h3></td>
        <td class="deno" align="center">'.$usuario["Numero"].'</td>
