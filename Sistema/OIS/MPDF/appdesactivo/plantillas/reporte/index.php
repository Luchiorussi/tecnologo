  ...
  $plantilla= '<body>
    ...
    <main>
      <div id="details" class="clearfix">
        ...
        <div id="invoice">
          <br>
          <h1 align="center">USUARIOS INACTIVOS </h1>
        </div>
      </div>
      <table border="0" cellspacing="0" cellpadding="0">
        <thead>
          <tr>
            <th class="no" align="center"><h4>Nombre</h4></th>
            <th class="desc" align="center"><h3>Apellido</h3></th>
            <th class="unit"><h3>Correo Electronico</h3></th>
            <th class="desc"><h3>Estado</h3></th>
      ...
      foreach($conexion as $usuario){
        ...
        <td class="unit" align="left">'.$usuario["CorreoElectronico"].'</td>  
        <td class="deno" align="left">Inactivo</td>       
      </tr>';
      }
